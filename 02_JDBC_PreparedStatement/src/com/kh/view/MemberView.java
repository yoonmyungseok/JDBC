...
public class MemberView {
	...
	public void updateMember() {
		...
		//어느 회원을 선택해서 어떤 값으로 변경할건지
		//필요한 데이터: 회원 선택용 - 회원 아이디(unique 제약조건)
		//				바꿀 내용 - 비밀번호, 이메일, 전화번호, 주소
		
		//변경할 회원의 아이디(WHERE 절에 들어갈 내용)
		System.out.print("변경할 회원의 아이디 입력: ");
		String userId=sc.nextLine();
		
		//바꿀 내용물들 - 비밀번호, 이메일, 전화번호, 주소(SET 절에 들어갈 내용)
		...
		//MemberController의 어떤 메소드에게 요청 처리(위의 매개변수를 넘길 예정)
	...
	public void deleteMember() {
		...
		//MemberController의 어떤 메소드를 호출해서 탈퇴 요청 처리
